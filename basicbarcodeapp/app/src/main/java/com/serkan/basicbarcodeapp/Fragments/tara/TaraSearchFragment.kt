...
import com.serkan.basicbarcodeapp.databinding.FragmentSearchTaraBinding
...
class TaraSearchFragment : Fragment(),ZXingScannerView.ResultHandler {

    private lateinit var mView:View
    private lateinit var scanner: ZXingScannerView
    private var _binding:FragmentSearchTaraBinding?=null
    ...
    override fun onCreateView(
        ...
        mView= inflater.inflate(R.layout.fragment_search_tara, container, false)
    ...
    override fun handleResult(p0: Result?) {
        if(p0!=null){
           ...
           val bundle = Bundle()
            bundle.putString("bcsearch",p0.text)
